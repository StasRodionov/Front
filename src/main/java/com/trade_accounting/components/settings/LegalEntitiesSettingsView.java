...
import com.trade_accounting.components.profile.CompanyModal;
...
@Route(value = PROFILE_PROFILE__SETTINGS__LEGAL_ENTITIES_SETTINGS, layout = AppView.class)
...
public class LegalEntitiesSettingsView extends VerticalLayout {
    ...
    public LegalEntitiesSettingsView(Notifications notifications, CompanyService companyService, AddressService addressService, LegalDetailService legalDetailService, TypeOfContractorService typeOfContractorService, BankAccountService bankAccountService) {
        ...
        add(getAppView(), getToolbar(), filter, grid, paginator);
    }
