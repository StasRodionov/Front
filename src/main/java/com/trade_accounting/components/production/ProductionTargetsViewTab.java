...
//           modalWindow.setProductionTargetsEdit(productionTargetsDto);
    ...
    private Button buttonQuestion() {
        ...
        HorizontalLayout horizontalLayout = new HorizontalLayout();
        Html content = new Html("<div><p>Производственное задание позволяет выстроить " +
                "процесс изготовления продукции по техкартам и рассчитать расходы. Тут же можно отмечать " +
                "выполнение производственных этапов и контролировать результаты.</p>" +
                "<p>Читать инструкцию: </p><p><a href=\"#\" target=\"_blank\">Расширенный учет производственных операций</a></p>" +
                "<p>Видео: </p><p><a href=\"#\" target=\"_blank\">Расширенный способ</a></p></div>");
