...
@UIScope
@SpringComponent
public class PrintInvoiceFunnelModalView extends Dialog {
    private final FunnelService funnelService;
    private final String pathForSaveXlsTemplate = "src/main/resources/xls_templates/sales_templates/funnel/invoice";

    public PrintInvoiceFunnelModalView(FunnelService funnelService) {
    ...
    private Select<String> valuePrint() {
        ...
        getXlsFiles().forEach(x -> print.add(getLinkToXlsInvoiceTemplate(x)));
        getXlsFiles().forEach(x -> print.add(getLinkToPdfInvoiceTemplate(x)));
        getXlsFiles().forEach(x -> print.add(getLinkToOdsInvoiceTemplate(x)));
        return print;
    }
