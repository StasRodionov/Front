...
import com.trade_accounting.controllers.dto.ProjectDto;
...
@UIScope
@Slf4j
public class ExpenseOrderModal extends Dialog {
    ...
    private Component getHeader() {
        ...
        H2 title = new H2("Расходный ордер");
