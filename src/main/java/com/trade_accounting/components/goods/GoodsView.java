...
public class GoodsView extends VerticalLayout {
    ...
    private final ServicesModalWindow servicesModalWindow;
    ...
    public GoodsView(ProductService productService,
                     ...
                     GoodsModalWindow goodsModalWindow, ServicesModalWindow servicesModalWindow) {
        this.productService = productService;
        this.productGroupService = productGroupService;
        this.goodsModalWindow = goodsModalWindow;
        this.servicesModalWindow = servicesModalWindow;
    ...
    private Button buttonPlusService() {
        ...
        addServiceButton.addClickListener(e -> servicesModalWindow.open());
